...
from prompter.prompt import Prompt
...
def test_picoprompter(mock_openai):
    ...
    pico_prompt = Prompt("How does the integration of digital health monitoring devices into routine patient care influence the management of chronic diseases and improve patient outcomes?")
